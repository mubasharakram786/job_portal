      ...
      <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(15,23,42,0.08);">
        ...
        <tr>
          <td style="padding:40px 40px 24px 40px;text-align:center;">
            <div style="width:64px;height:64px;background-color:#fef2f2;border-radius:50%;margin:0 auto 24px auto;line-height:64px;font-size:28px;">🔒</div>
            <h1 style="margin:0 0 12px 0;font-size:22px;color:#0f172a;">Reset your password</h1>
            <p style="margin:0;font-size:15px;line-height:1.6;color:#475569;">
              Hi <strong style="color:#0f172a;">${email}</strong>, we received a request to reset your password. Click the button below to choose a new one.
            </p>
          </td>
        </tr>
        <tr>
          <td style="padding:8px 40px 32px 40px;text-align:center;">
            <a href="${resetLink}" target="_blank" style="display:inline-block;background-color:#dc2626;color:#ffffff;font-size:16px;font-weight:600;text-decoration:none;padding:14px 36px;border-radius:10px;box-shadow:0 6px 16px rgba(220,38,38,0.35);">
              Reset Password
            </a>
          </td>
        </tr>
        <tr>
          <td style="padding:0 40px 32px 40px;text-align:center;">
            ...
            <p style="margin:8px 0 0 0;font-size:13px;word-break:break-all;">
              <a href="${resetLink}" target="_blank" style="color:#dc2626;text-decoration:none;">${resetLink}</a>
            </p>
          </td>
        </tr>
        <tr>
